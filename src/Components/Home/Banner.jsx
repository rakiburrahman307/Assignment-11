    ...
    const textField = <>
        ...
        <div className="absolute flex items-center rounded-xl h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
            <div className=' w-1/2 text-white pl-10 space-y-8'>
                ...
                <p>Explore a world of opportunities and take the next step in your professional journey with JobSwift Industries Ltd.
                    We are dedicated to connecting talented individuals with rewarding careers. Your dream job awaits!</p>
                <div className="flex">
